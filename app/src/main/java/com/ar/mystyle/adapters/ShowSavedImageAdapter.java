 ...
 */
public class ShowSavedImageAdapter extends RecyclerView.Adapter<ShowSavedImageAdapter.ViewHolder1>  {
    private ArrayList<String> images;
    private Context context;
    private ClickListener clickListener;

    public ShowSavedImageAdapter(ArrayList<String> images, Context context, ClickListener clickListener)
    {
        this.images=images;
    ...
    @Override
    public ShowSavedImageAdapter.ViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_saved_image, parent, false);
    ...
    public void onBindViewHolder(ViewHolder1 holder, final int position) {
        if(position%3==0)
            holder.imageView.getLayoutParams().height= Utility.dpToPx(250,context);
