 ...
 */
public class MyCollectionAdapter extends RecyclerView.Adapter<MyCollectionAdapter.ViewHolder1>  {
    private ArrayList<String> images;
    private Context context;
    private ClickListener clickListener;

    public MyCollectionAdapter(ArrayList<String> images, Context context, ClickListener clickListener)
    {
        this.images=images;
    ...
    @Override
    public MyCollectionAdapter.ViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
